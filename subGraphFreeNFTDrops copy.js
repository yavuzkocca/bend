...
const subGraph = () => {
    setInterval(() => {
        ...
        client.query(QUERY, { createdAt_gte: 1712134011 }).toPromise().then(result => {
...
const createCollection = async (nft) => {
    ...
    } else if (nft.imageUrl == "https://img.freepik.com/free-vector/silver-blurred-background_1034-253.jpg?size=338&ext=jpg&ga=GA1.1.1395880969.1710028800&semt=ais") {
